...
static const int64 MAX_MONEY = 10000000000 * COIN; // maximum of 10 billion coins per transaction
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // 1440 blocks found a day. Priority cutoff is 1 HDC day / 250 bytes.
    }
